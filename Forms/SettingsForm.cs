...
namespace TLO.local
{
  public class SettingsForm : Form
  {
    ...
    private void _Focus_Enter(object sender, EventArgs e)
    {
      ...
      else
      {
        if (sender != this._CategoriesTbLabel)
          return;
        current1.Label = string.IsNullOrWhiteSpace(this._CategoriesTbLabel.Text) ? current1.FullName : this._CategoriesTbLabel.Text.Trim();
      }
    }
    ...
    private void SelectionChanged(object sender, EventArgs e)
    {
      ...
      if (sender == this.dgwCategories)
      {
        ...
        else
        {
          ...
          this._CategoriesCbTorrentClient.SelectedItem = (object) (this._CategoriesCbTorrentClient.DataSource as List<TorrentClientInfo>).Where<TorrentClientInfo>((Func<TorrentClientInfo, bool>) (x => x.UID == obj.TorrentClientUID)).FirstOrDefault<TorrentClientInfo>();
    ...
    private void ClickButtons(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        else if (sender == this._btTorrentClientDelete)
        {
          if (this._TorrentClientsSource.Current == null)
            return;
          TorrentClientInfo current = this._TorrentClientsSource.Current as TorrentClientInfo;
          if (MessageBox.Show("Вы хотите удалить из списка torrent-клиент \"" + current.Name + "\"?", "Запрос подтверждения", MessageBoxButtons.YesNo, MessageBoxIcon.Asterisk) == DialogResult.Yes)
      ...
      try
      {
        if (sender == this._btCategoryAdd)
        {
          ...
          if (dialog.ShowDialog() == DialogResult.OK)
          {
            ...
            if (dialog.SelectedCategory == null)
              return;
            if ((this._CategoriesSource.DataSource as List<Category>).Any<Category>((Func<Category, bool>) (x => x.CategoryID == dialog.SelectedCategory.CategoryID)))
            {
        ...
        else if (sender == this._btCategoryRemove)
        {
          ...
          if (MessageBox.Show("Удалить из обработки раздел \"" + current.Name + "\"?", "Подтверждение", MessageBoxButtons.YesNo, MessageBoxIcon.Asterisk) == DialogResult.Yes)
        ...
        else if (sender == this._CategoriesBtSelectFolder)
        {
          ...
          folderBrowserDialog.SelectedPath = string.IsNullOrWhiteSpace(current.Folder) ? "c:\\" : current.Folder;
      ...
      try
      {
        ...
        {
          ClientLocalDB.Current.SaveTorrentClients((IEnumerable<TorrentClientInfo>) (this._TorrentClientsSource.DataSource as List<TorrentClientInfo>), true);
          ClientLocalDB.Current.CategoriesSave((IEnumerable<Category>) (this._CategoriesSource.DataSource as List<Category>), false);
        ...
        else
        {
          ...
          foreach (TorrentClientInfo torrentClientInfo in this._TorrentClientsSource.DataSource as List<TorrentClientInfo>)
          {
            try
            {
              ITorrentClient torrentClient = torrentClientInfo.Create();
              if (torrentClient == null)
                stringList.Add(string.Format("Торрент-клиент \"{0}\": Не удалось определить тип torrent-клиента", (object) torrentClientInfo.Name));
              else
                torrentClient.Ping();
            }
            catch
            {
              stringList.Add(string.Format("Не удалось подключиться к торрент-клиенту \"{0}\"", (object) torrentClientInfo.Name));
            }
          }
    ...
    private void CreatePageAllCategories()
    {
      ...
      Dictionary<int, Category> dictionary1 = ClientLocalDB.Current.GetCategories().ToDictionary<Category, int, Category>((Func<Category, int>) (x => x.CategoryID), (Func<Category, Category>) (x => x));
      Dictionary<int, Category> categoriesEnable = ClientLocalDB.Current.GetCategoriesEnable().ToDictionary<Category, int, Category>((Func<Category, int>) (x => x.CategoryID), (Func<Category, Category>) (x => x));
      categoriesEnable.ToDictionary<KeyValuePair<int, Category>, int, int>((Func<KeyValuePair<int, Category>, int>) (x => x.Key), (Func<KeyValuePair<int, Category>, int>) (x => x.Value.ParentID));
      ...
      for (int index = 0; index < 3; ++index)
      {
        ...
        foreach (Category category1 in categoriesEnable.Values.ToList<Category>())
        {
          ...
          {
            if (!categoriesEnable.ContainsKey(category2.CategoryID) && dictionary1.ContainsKey(category2.CategoryID))
              categoriesEnable.Add(category2.CategoryID, category2);
          }
        }
      }
      Dictionary<int, string> dictionary2 = ClientLocalDB.Current.GetReports(new int?()).Where<KeyValuePair<Tuple<int, int>, Tuple<string, string>>>((Func<KeyValuePair<Tuple<int, int>, Tuple<string, string>>, bool>) (x =>
      {
        if (x.Key.Item2 == 0)
          return (uint) x.Key.Item1 > 0U;
        return false;
      })).ToDictionary<KeyValuePair<Tuple<int, int>, Tuple<string, string>>, int, string>((Func<KeyValuePair<Tuple<int, int>, Tuple<string, string>>, int>) (x => x.Key.Item1), (Func<KeyValuePair<Tuple<int, int>, Tuple<string, string>>, string>) (x => x.Value.Item1));
      int num = 0;
      int y1 = 10;
      foreach (Category category in (IEnumerable<Category>) categoriesEnable.Values.OrderBy<Category, string>((Func<Category, string>) (x => x.FullName)))
      {
        ...
        textBox.Text = !string.IsNullOrWhiteSpace(category.ReportList) || !dictionary2.ContainsKey(category.CategoryID) ? category.ReportList : dictionary2[category.CategoryID];
    ...
    {
      this._btCheck = new Button();
      this._btCancel = new Button();
      this._btSave = new Button();
      this._tpCategories = new TabPage();
      this.panel1 = new Panel();
      this.groupBox7 = new GroupBox();
      this._CategoriesTbLabel = new TextBox();
      this.label40 = new Label();
      this._cbIsSaveTorrentFile = new CheckBox();
      this._cbIsSaveWebPage = new CheckBox();
      this._CategoriesCbTorrentClient = new ComboBox();
      this.label3 = new Label();
      this._CategoriesTbFolderDownloads = new TextBox();
      this._cbSubFolder = new ComboBox();
      this.label22 = new Label();
      this._CategoriesBtSelectFolder = new Button();
      this.label18 = new Label();
      this.label16 = new Label();
      this._CategoriesCbStartCountSeeders = new ComboBox();
      this.label15 = new Label();
      this.groupBox6 = new GroupBox();
      this._CategoriesTbFullName = new TextBox();
      this.label14 = new Label();
      this._CategoriesTbCategoryID = new TextBox();
      this.label13 = new Label();
      this._btCategoryRemove = new Button();
      this._btCategoryAdd = new Button();
      this.dgwCategories = new DataGridView();
      this.ColumnCategoryCategoryID = new DataGridViewTextBoxColumn();
      this.ColumnCategoryName = new DataGridViewTextBoxColumn();
      this.tbpTorrentClients = new TabPage();
      this.groupBox5 = new GroupBox();
      this._btTorrentClientAdd = new Button();
      this._btTorrentClientDelete = new Button();
      this.groupBox3 = new GroupBox();
      this._tcrbRemote = new RadioButton();
      this._tcrbCurrent = new RadioButton();
      this._tbTorrentClientHostIP = new TextBox();
      this.label7 = new Label();
      this.label6 = new Label();
      this._tbTorrentClientUserPassword = new TextBox();
      this._tbTorrentClientUserName = new TextBox();
      this._tbTorrentClientPort = new TextBox();
      this.label5 = new Label();
      this.dgwTorrentClients = new DataGridView();
      this.UID = new DataGridViewTextBoxColumn();
      this.FolderName = new DataGridViewTextBoxColumn();
      this._cbTorrentClientType = new ComboBox();
      this.label2 = new Label();
      this.label1 = new Label();
      this._tbTorrentClientName = new TextBox();
      ...
      this._appReportBottom = new TextBox();
      this.label31 = new Label();
      this.label30 = new Label();
      this._appReportTop2 = new TextBox();
      this._appReportTop1 = new TextBox();
      ...
      this._appReportLine = new TextBox();
      this.label17 = new Label();
      this.label9 = new Label();
      this._appCountSeedersReport = new NumericUpDown();
      this.label19 = new Label();
      this.groupBox4 = new GroupBox();
      this._appIsNotSaveStatistics = new CheckBox();
      this.label23 = new Label();
      this._appLogLevel = new NumericUpDown();
      this.label21 = new Label();
      this.label20 = new Label();
      this._appSelectLessOrEqual = new CheckBox();
      this.label12 = new Label();
      this._appIsUpdateStatistics = new CheckBox();
      this._appPeriodRunAndStopTorrents = new NumericUpDown();
      this.label11 = new Label();
      this.groupBox2 = new GroupBox();
      this._appCountDaysKeepHistory = new NumericUpDown();
      this.label10 = new Label();
      this._appIsAvgCountSeeders = new CheckBox();
      this.groupBox1 = new GroupBox();
      this.label8 = new Label();
      this._appKeeperPass = new TextBox();
      this._appKeeperName = new TextBox();
      this.label4 = new Label();
      this.tabPage1 = new TabPage();
      this.forumPages1 = new ForumPages();
      this._tpAllCategories = new TabPage();
      this.panel2 = new Panel();
      this._tpCategories.SuspendLayout();
      this.panel1.SuspendLayout();
      this.groupBox7.SuspendLayout();
      this.groupBox6.SuspendLayout();
      ((ISupportInitialize) this.dgwCategories).BeginInit();
      this.tbpTorrentClients.SuspendLayout();
      this.groupBox5.SuspendLayout();
      this.groupBox3.SuspendLayout();
      ((ISupportInitialize) this.dgwTorrentClients).BeginInit();
      this.tabControl1.SuspendLayout();
      this.tabPage2.SuspendLayout();
      this.groupBox8.SuspendLayout();
      this._appCountSeedersReport.BeginInit();
      this.groupBox4.SuspendLayout();
      this._appLogLevel.BeginInit();
      this._appPeriodRunAndStopTorrents.BeginInit();
      this.groupBox2.SuspendLayout();
      this._appCountDaysKeepHistory.BeginInit();
      this.groupBox1.SuspendLayout();
      this.tabPage1.SuspendLayout();
      this._tpAllCategories.SuspendLayout();
      this.SuspendLayout();
      this._btCheck.Anchor = AnchorStyles.Bottom | AnchorStyles.Right;
      this._btCheck.Location = new Point(12, 623);
      this._btCheck.Name = "_btCheck";
      this._btCheck.Size = new Size(75, 23);
      this._btCheck.TabIndex = 16;
      this._btCheck.Text = "Проверить";
      this._btCheck.UseVisualStyleBackColor = true;
      this._btCheck.Click += new EventHandler(this.ClickButtons);
      this._btCancel.Anchor = AnchorStyles.Bottom | AnchorStyles.Right;
      this._btCancel.Location = new Point(970, 623);
      ...
      this._btCancel.Click += new EventHandler(this.ClickButtons);
      this._btSave.Anchor = AnchorStyles.Bottom | AnchorStyles.Right;
      this._btSave.Location = new Point(889, 623);
      this._btSave.Name = "_btSave";
      this._btSave.Size = new Size(75, 23);
      this._btSave.TabIndex = 14;
      this._btSave.Text = "Сохранить";
      this._btSave.UseVisualStyleBackColor = true;
      this._btSave.Click += new EventHandler(this.ClickButtons);
      this._tpCategories.Controls.Add((Control) this.panel1);
      this._tpCategories.Controls.Add((Control) this._btCategoryRemove);
      this._tpCategories.Controls.Add((Control) this._btCategoryAdd);
      this._tpCategories.Controls.Add((Control) this.dgwCategories);
      this._tpCategories.Location = new Point(4, 22);
      this._tpCategories.Name = "_tpCategories";
      this._tpCategories.Padding = new Padding(3);
      this._tpCategories.Size = new Size(1041, 591);
      ...
      this.panel1.Location = new Point(254, 35);
      this.panel1.Name = "panel1";
      this.panel1.Size = new Size(787, 550);
      this.panel1.TabIndex = 6;
      this.groupBox7.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
      this.groupBox7.Controls.Add((Control) this._CategoriesTbLabel);
      this.groupBox7.Controls.Add((Control) this.label40);
      this.groupBox7.Controls.Add((Control) this._cbIsSaveTorrentFile);
      this.groupBox7.Controls.Add((Control) this._cbIsSaveWebPage);
      this.groupBox7.Controls.Add((Control) this._CategoriesCbTorrentClient);
      this.groupBox7.Controls.Add((Control) this.label3);
      this.groupBox7.Controls.Add((Control) this._CategoriesTbFolderDownloads);
      this.groupBox7.Controls.Add((Control) this._cbSubFolder);
      this.groupBox7.Controls.Add((Control) this.label22);
      this.groupBox7.Controls.Add((Control) this._CategoriesBtSelectFolder);
      this.groupBox7.Controls.Add((Control) this.label18);
      this.groupBox7.Controls.Add((Control) this.label16);
      this.groupBox7.Controls.Add((Control) this._CategoriesCbStartCountSeeders);
      this.groupBox7.Controls.Add((Control) this.label15);
      this.groupBox7.Location = new Point(3, 122);
      this.groupBox7.Name = "groupBox7";
      this.groupBox7.Size = new Size(778, 235);
      this.groupBox7.TabIndex = 6;
      this.groupBox7.TabStop = false;
      this._CategoriesTbLabel.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
      this._CategoriesTbLabel.Location = new Point(115, 202);
      this._CategoriesTbLabel.Name = "_CategoriesTbLabel";
      this._CategoriesTbLabel.Size = new Size(657, 20);
      this._CategoriesTbLabel.TabIndex = 15;
      this._CategoriesTbLabel.Enter += new EventHandler(this._Focus_Enter);
      this._CategoriesTbLabel.Leave += new EventHandler(this._Focus_Enter);
      this.label40.AutoSize = true;
      this.label40.Location = new Point(6, 205);
      this.label40.Name = "label40";
      this.label40.Size = new Size(103, 13);
      this.label40.TabIndex = 14;
      this.label40.Text = "Установить метку:";
      this._cbIsSaveTorrentFile.AutoSize = true;
      this._cbIsSaveTorrentFile.Location = new Point(9, 156);
      this._cbIsSaveTorrentFile.Name = "_cbIsSaveTorrentFile";
      this._cbIsSaveTorrentFile.Size = new Size(305, 17);
      ...
      this._cbIsSaveTorrentFile.CheckedChanged += new EventHandler(this._Focus_Enter);
      this._cbIsSaveWebPage.AutoSize = true;
      this._cbIsSaveWebPage.Location = new Point(9, 179);
      this._cbIsSaveWebPage.Name = "_cbIsSaveWebPage";
      this._cbIsSaveWebPage.Size = new Size(354, 17);
      ...
      this._cbIsSaveWebPage.CheckedChanged += new EventHandler(this._Focus_Enter);
      this._CategoriesCbTorrentClient.DropDownStyle = ComboBoxStyle.DropDownList;
      this._CategoriesCbTorrentClient.FormattingEnabled = true;
      this._CategoriesCbTorrentClient.Location = new Point(336, 59);
      this._CategoriesCbTorrentClient.Name = "_CategoriesCbTorrentClient";
      this._CategoriesCbTorrentClient.Size = new Size(436, 21);
      this._CategoriesCbTorrentClient.TabIndex = 11;
      this._CategoriesCbTorrentClient.SelectionChangeCommitted += new EventHandler(this._Focus_Enter);
      this.label3.AutoSize = true;
      this.label3.Location = new Point(6, 62);
      this.label3.Name = "label3";
      this.label3.Size = new Size(273, 13);
      this.label3.TabIndex = 10;
      this.label3.Text = "Торрент-клиент, куда требуется добавлять раздачи:";
      this._CategoriesTbFolderDownloads.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
      this._CategoriesTbFolderDownloads.Location = new Point(9, 103);
      this._CategoriesTbFolderDownloads.Name = "_CategoriesTbFolderDownloads";
      this._CategoriesTbFolderDownloads.Size = new Size(733, 20);
      this._CategoriesTbFolderDownloads.TabIndex = 5;
      this._CategoriesTbFolderDownloads.Enter += new EventHandler(this._Focus_Enter);
      this._CategoriesTbFolderDownloads.Leave += new EventHandler(this._Focus_Enter);
      this._cbSubFolder.DropDownStyle = ComboBoxStyle.DropDownList;
      this._cbSubFolder.FormattingEnabled = true;
      this._cbSubFolder.Items.AddRange(new object[3]
      {
        (object) "Не нужен",
        (object) "С ID топика",
        (object) "Запрашивать"
      });
      this._cbSubFolder.Location = new Point(336, 129);
      this._cbSubFolder.Name = "_cbSubFolder";
      this._cbSubFolder.Size = new Size(270, 21);
      this._cbSubFolder.TabIndex = 9;
      this._cbSubFolder.SelectionChangeCommitted += new EventHandler(this._Focus_Enter);
      this.label22.AutoSize = true;
      this.label22.Location = new Point(6, 132);
      this.label22.Name = "label22";
      this.label22.Size = new Size(261, 13);
      this.label22.TabIndex = 8;
      this.label22.Text = "Создавать подкаталог для добавляемой раздачи:";
      this._CategoriesBtSelectFolder.Anchor = AnchorStyles.Top | AnchorStyles.Right;
      this._CategoriesBtSelectFolder.Location = new Point(742, 102);
      this._CategoriesBtSelectFolder.Name = "_CategoriesBtSelectFolder";
      this._CategoriesBtSelectFolder.Size = new Size(30, 22);
      ...
      this._CategoriesBtSelectFolder.Click += new EventHandler(this.ClickButtons);
      this.label18.AutoSize = true;
      this.label18.Location = new Point(6, 87);
      this.label18.Name = "label18";
      this.label18.Size = new Size(298, 13);
      ...
      this.label16.Location = new Point(6, 43);
      this.label16.Name = "label16";
      this.label16.Size = new Size(359, 13);
      this.label16.TabIndex = 2;
      this.label16.Text = "Остановка происходит при кол-ве сидов больше этого на 2 и больше";
      this._CategoriesCbStartCountSeeders.DropDownStyle = ComboBoxStyle.DropDownList;
      this._CategoriesCbStartCountSeeders.FormattingEnabled = true;
      this._CategoriesCbStartCountSeeders.Items.AddRange(new object[12]
      {
        (object) "-",
        (object) "0",
        (object) "1",
      ...
      this._CategoriesCbStartCountSeeders.Location = new Point(336, 19);
      this._CategoriesCbStartCountSeeders.Name = "_CategoriesCbStartCountSeeders";
      this._CategoriesCbStartCountSeeders.Size = new Size(61, 21);
      this._CategoriesCbStartCountSeeders.TabIndex = 1;
      this._CategoriesCbStartCountSeeders.SelectionChangeCommitted += new EventHandler(this._Focus_Enter);
      this.label15.AutoSize = true;
      this.label15.Location = new Point(6, 22);
      this.label15.Name = "label15";
      this.label15.Size = new Size(225, 13);
      ...
      this.groupBox6.Controls.Add((Control) this._CategoriesTbFullName);
      this.groupBox6.Controls.Add((Control) this.label14);
      this.groupBox6.Controls.Add((Control) this._CategoriesTbCategoryID);
      this.groupBox6.Controls.Add((Control) this.label13);
      this.groupBox6.Location = new Point(3, 3);
      this.groupBox6.Name = "groupBox6";
      this.groupBox6.Size = new Size(778, 113);
      this.groupBox6.TabIndex = 5;
      this.groupBox6.TabStop = false;
      this.groupBox6.Text = "Данные о выбраном разделе";
      this._CategoriesTbFullName.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
      this._CategoriesTbFullName.Location = new Point(6, 58);
      ...
      this._CategoriesTbFullName.Size = new Size(766, 49);
      this._CategoriesTbFullName.TabIndex = 3;
      this.label14.AutoSize = true;
      this.label14.Location = new Point(6, 42);
      this.label14.Name = "label14";
      this.label14.Size = new Size(128, 13);
      this.label14.TabIndex = 2;
      this.label14.Text = "Полный путь к разделу:";
      this._CategoriesTbCategoryID.Location = new Point(96, 19);
      this._CategoriesTbCategoryID.Name = "_CategoriesTbCategoryID";
      this._CategoriesTbCategoryID.ReadOnly = true;
      this._CategoriesTbCategoryID.Size = new Size(100, 20);
      this._CategoriesTbCategoryID.TabIndex = 1;
      this.label13.AutoSize = true;
      this.label13.Location = new Point(6, 22);
      this.label13.Name = "label13";
      this.label13.Size = new Size(84, 13);
      this.label13.TabIndex = 0;
      this.label13.Text = "№ подраздела:";
      this._btCategoryRemove.Location = new Point(131, 6);
      this._btCategoryRemove.Name = "_btCategoryRemove";
      this._btCategoryRemove.Size = new Size(117, 23);
      this._btCategoryRemove.TabIndex = 4;
      this._btCategoryRemove.Text = "Удалить";
      this._btCategoryRemove.UseVisualStyleBackColor = true;
      this._btCategoryRemove.Click += new EventHandler(this.ClickButtons);
      this._btCategoryAdd.Location = new Point(8, 6);
      this._btCategoryAdd.Name = "_btCategoryAdd";
      this._btCategoryAdd.Size = new Size(117, 23);
      this._btCategoryAdd.TabIndex = 3;
      this._btCategoryAdd.Text = "Добавить";
      this._btCategoryAdd.UseVisualStyleBackColor = true;
      this._btCategoryAdd.Click += new EventHandler(this.ClickButtons);
      this.dgwCategories.AllowUserToAddRows = false;
      this.dgwCategories.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left;
      this.dgwCategories.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
      this.dgwCategories.Columns.AddRange((DataGridViewColumn) this.ColumnCategoryCategoryID, (DataGridViewColumn) this.ColumnCategoryName);
      this.dgwCategories.Location = new Point(8, 35);
      ...
      this.dgwCategories.Size = new Size(240, 550);
      this.dgwCategories.TabIndex = 0;
      this.dgwCategories.SelectionChanged += new EventHandler(this.SelectionChanged);
      ...
      this.ColumnCategoryName.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
      ...
      this.tbpTorrentClients.BackColor = SystemColors.Control;
      this.tbpTorrentClients.Controls.Add((Control) this.groupBox5);
      this.tbpTorrentClients.Location = new Point(4, 22);
      this.tbpTorrentClients.Name = "tbpTorrentClients";
      this.tbpTorrentClients.Padding = new Padding(3);
      this.tbpTorrentClients.Size = new Size(1041, 591);
      ...
      this.groupBox5.Controls.Add((Control) this._btTorrentClientAdd);
      this.groupBox5.Controls.Add((Control) this._btTorrentClientDelete);
      this.groupBox5.Controls.Add((Control) this.groupBox3);
      this.groupBox5.Controls.Add((Control) this.dgwTorrentClients);
      this.groupBox5.Controls.Add((Control) this._cbTorrentClientType);
      this.groupBox5.Controls.Add((Control) this.label2);
      this.groupBox5.Controls.Add((Control) this.label1);
      this.groupBox5.Controls.Add((Control) this._tbTorrentClientName);
      this.groupBox5.Location = new Point(8, 6);
      this.groupBox5.Name = "groupBox5";
      this.groupBox5.Size = new Size(1026, 360);
      this.groupBox5.TabIndex = 11;
      this.groupBox5.TabStop = false;
      this.groupBox5.Text = "Torrent-клиенты";
      this._btTorrentClientAdd.Location = new Point(6, 19);
      this._btTorrentClientAdd.Name = "_btTorrentClientAdd";
      this._btTorrentClientAdd.Size = new Size(117, 23);
      ...
      this._btTorrentClientAdd.Click += new EventHandler(this.ClickButtons);
      this._btTorrentClientDelete.Location = new Point(129, 19);
      this._btTorrentClientDelete.Name = "_btTorrentClientDelete";
      this._btTorrentClientDelete.Size = new Size(117, 23);
      ...
      this._btTorrentClientDelete.Click += new EventHandler(this.ClickButtons);
      this.groupBox3.Controls.Add((Control) this._tcrbRemote);
      this.groupBox3.Controls.Add((Control) this._tcrbCurrent);
      this.groupBox3.Controls.Add((Control) this._tbTorrentClientHostIP);
      this.groupBox3.Controls.Add((Control) this.label7);
      this.groupBox3.Controls.Add((Control) this.label6);
      this.groupBox3.Controls.Add((Control) this._tbTorrentClientUserPassword);
      this.groupBox3.Controls.Add((Control) this._tbTorrentClientUserName);
      this.groupBox3.Controls.Add((Control) this._tbTorrentClientPort);
      this.groupBox3.Controls.Add((Control) this.label5);
      this.groupBox3.Location = new Point((int) byte.MaxValue, 98);
      this.groupBox3.Name = "groupBox3";
      this.groupBox3.Size = new Size(636, 151);
      this.groupBox3.TabIndex = 8;
      this.groupBox3.TabStop = false;
      this.groupBox3.Text = "Доступ к torrent-клиенту";
      this._tcrbRemote.AutoSize = true;
      this._tcrbRemote.Location = new Point(9, 43);
      this._tcrbRemote.Name = "_tcrbRemote";
      this._tcrbRemote.Size = new Size(211, 17);
      ...
      this._tcrbRemote.CheckedChanged += new EventHandler(this._Focus_Enter);
      this._tcrbCurrent.AutoSize = true;
      this._tcrbCurrent.Checked = true;
      this._tcrbCurrent.Location = new Point(9, 20);
      this._tcrbCurrent.Name = "_tcrbCurrent";
      this._tcrbCurrent.Size = new Size(150, 17);
      ...
      this._tcrbCurrent.CheckedChanged += new EventHandler(this._Focus_Enter);
      this._tbTorrentClientHostIP.Location = new Point(226, 42);
      this._tbTorrentClientHostIP.Name = "_tbTorrentClientHostIP";
      this._tbTorrentClientHostIP.Size = new Size(150, 20);
      this._tbTorrentClientHostIP.TabIndex = 6;
      this._tbTorrentClientHostIP.Enter += new EventHandler(this._Focus_Enter);
      this._tbTorrentClientHostIP.Leave += new EventHandler(this._Focus_Enter);
      ...
      this.label6.Location = new Point(6, 97);
      this.label6.Name = "label6";
      this.label6.Size = new Size(183, 13);
      this.label6.TabIndex = 4;
      this.label6.Text = "Имя пользователя torrent-клиента:";
      this._tbTorrentClientUserPassword.Location = new Point(226, 120);
      this._tbTorrentClientUserPassword.Name = "_tbTorrentClientUserPassword";
      this._tbTorrentClientUserPassword.PasswordChar = '*';
      this._tbTorrentClientUserPassword.Size = new Size(150, 20);
      this._tbTorrentClientUserPassword.TabIndex = 3;
      this._tbTorrentClientUserPassword.Enter += new EventHandler(this._Focus_Enter);
      this._tbTorrentClientUserPassword.Leave += new EventHandler(this._Focus_Enter);
      this._tbTorrentClientUserName.Location = new Point(226, 94);
      this._tbTorrentClientUserName.Name = "_tbTorrentClientUserName";
      this._tbTorrentClientUserName.Size = new Size(150, 20);
      this._tbTorrentClientUserName.TabIndex = 2;
      this._tbTorrentClientUserName.Enter += new EventHandler(this._Focus_Enter);
      this._tbTorrentClientUserName.Leave += new EventHandler(this._Focus_Enter);
      this._tbTorrentClientPort.Location = new Point(226, 68);
      this._tbTorrentClientPort.Name = "_tbTorrentClientPort";
      this._tbTorrentClientPort.Size = new Size(150, 20);
      this._tbTorrentClientPort.TabIndex = 1;
      this._tbTorrentClientPort.Enter += new EventHandler(this._Focus_Enter);
      this._tbTorrentClientPort.Leave += new EventHandler(this._Focus_Enter);
      this.label5.AutoSize = true;
      this.label5.Location = new Point(6, 71);
      ...
      this.dgwTorrentClients.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left;
      this.dgwTorrentClients.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
      this.dgwTorrentClients.Columns.AddRange((DataGridViewColumn) this.UID, (DataGridViewColumn) this.FolderName);
      this.dgwTorrentClients.Location = new Point(6, 48);
      ...
      this.dgwTorrentClients.Size = new Size(240, 306);
      this.dgwTorrentClients.TabIndex = 0;
      this.dgwTorrentClients.SelectionChanged += new EventHandler(this.SelectionChanged);
      this.UID.DataPropertyName = "UID";
      this.UID.HeaderText = "UID";
      this.UID.Name = "UID";
      this.UID.ReadOnly = true;
      this.UID.Visible = false;
      this.FolderName.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
      this.FolderName.DataPropertyName = "Name";
      this.FolderName.HeaderText = "Настройки";
      this.FolderName.Name = "FolderName";
      this.FolderName.ReadOnly = true;
      this._cbTorrentClientType.DropDownStyle = ComboBoxStyle.DropDownList;
      this._cbTorrentClientType.FormattingEnabled = true;
      this._cbTorrentClientType.Items.AddRange(new object[3]
      {
        (object) "uTorrent",
        (object) "Transmission",
        (object) "Vuze (Vuze Web Remote)"
      });
      this._cbTorrentClientType.Location = new Point(481, 71);
      this._cbTorrentClientType.Name = "_cbTorrentClientType";
      this._cbTorrentClientType.Size = new Size(121, 21);
      this._cbTorrentClientType.TabIndex = 6;
      this._cbTorrentClientType.Enter += new EventHandler(this._Focus_Enter);
      this._cbTorrentClientType.Leave += new EventHandler(this._Focus_Enter);
      this.label2.AutoSize = true;
      this.label2.Location = new Point(252, 74);
      this.label2.Name = "label2";
      this.label2.Size = new Size(103, 13);
      this.label2.TabIndex = 7;
      this.label2.Text = "Тип torrent-клиента";
      this.label1.AutoSize = true;
      this.label1.Location = new Point(252, 48);
      this.label1.Name = "label1";
      this.label1.Size = new Size(226, 13);
      this.label1.TabIndex = 5;
      this.label1.Text = "Название группы настроек torrent-клиента:";
      this._tbTorrentClientName.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
      this._tbTorrentClientName.Location = new Point(481, 45);
      this._tbTorrentClientName.Name = "_tbTorrentClientName";
      this._tbTorrentClientName.Size = new Size(539, 20);
      this._tbTorrentClientName.TabIndex = 4;
      this._tbTorrentClientName.Enter += new EventHandler(this._Focus_Enter);
      this._tbTorrentClientName.Leave += new EventHandler(this._Focus_Enter);
      this.tabControl1.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
      this.tabControl1.Controls.Add((Control) this.tabPage2);
      this.tabControl1.Controls.Add((Control) this.tbpTorrentClients);
      this.tabControl1.Controls.Add((Control) this._tpCategories);
      this.tabControl1.Controls.Add((Control) this.tabPage1);
      this.tabControl1.Controls.Add((Control) this._tpAllCategories);
      this.tabControl1.Location = new Point(0, 0);
      this.tabControl1.Name = "tabControl1";
      this.tabControl1.SelectedIndex = 0;
      this.tabControl1.Size = new Size(1049, 617);
      ...
      this.tabPage2.Size = new Size(1041, 591);
      ...
      this.groupBox8.Controls.Add((Control) this._appReportBottom);
      this.groupBox8.Controls.Add((Control) this.label31);
      this.groupBox8.Controls.Add((Control) this.label30);
      this.groupBox8.Controls.Add((Control) this._appReportTop2);
      this.groupBox8.Controls.Add((Control) this._appReportTop1);
      ...
      this.label36.Location = new Point(229, 326);
      this.label36.Name = "label36";
      this.label36.Size = new Size(197, 13);
      this.label36.TabIndex = 28;
      this.label36.Text = "%%Top1%% - Вписать первый шаблон";
      this.label35.AutoSize = true;
      this.label35.ForeColor = SystemColors.ControlDark;
      this.label35.Location = new Point(6, 352);
      this.label35.Name = "label35";
      this.label35.Size = new Size(196, 13);
      this.label35.TabIndex = 27;
      this.label35.Text = "%%SizeTopics%% - Размер хранимого";
      this.label34.AutoSize = true;
      this.label34.ForeColor = SystemColors.ControlDark;
      this.label34.Location = new Point(6, 339);
      this.label34.Name = "label34";
      this.label34.Size = new Size(180, 13);
      this.label34.TabIndex = 26;
      this.label34.Text = "%%CountTopics%% - Кол-во раздач";
      this.label33.AutoSize = true;
      this.label33.ForeColor = SystemColors.ControlDark;
      this.label33.Location = new Point(6, 326);
      this.label33.Name = "label33";
      this.label33.Size = new Size(196, 13);
      this.label33.TabIndex = 25;
      this.label33.Text = "%%CreateDate%% - Дата составления";
      this.label32.AutoSize = true;
      this.label32.Location = new Point(6, 382);
      this.label32.Name = "label32";
      this.label32.Size = new Size(94, 13);
      this.label32.TabIndex = 24;
      this.label32.Text = "Шаблон подвала:";
      this._appReportBottom.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
      this._appReportBottom.Location = new Point(6, 398);
      this._appReportBottom.Multiline = true;
      this._appReportBottom.Name = "_appReportBottom";
      this._appReportBottom.ScrollBars = ScrollBars.Vertical;
      this._appReportBottom.Size = new Size(638, 79);
      this._appReportBottom.TabIndex = 23;
      this.label31.AutoSize = true;
      this.label31.Location = new Point(6, 228);
      this.label31.Name = "label31";
      this.label31.Size = new Size(162, 13);
      this.label31.TabIndex = 22;
      this.label31.Text = "Шаблон общей шапки отчетов:";
      this.label30.AutoSize = true;
      this.label30.Location = new Point(6, (int) sbyte.MaxValue);
      this.label30.Name = "label30";
      this.label30.Size = new Size(164, 13);
      this.label30.TabIndex = 21;
      this.label30.Text = "Шаблон шапки первого отчета:";
      this._appReportTop2.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
      this._appReportTop2.Location = new Point(9, 244);
      this._appReportTop2.Multiline = true;
      this._appReportTop2.Name = "_appReportTop2";
      this._appReportTop2.ScrollBars = ScrollBars.Vertical;
      this._appReportTop2.Size = new Size(638, 79);
      this._appReportTop2.TabIndex = 20;
      this._appReportTop1.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
      this._appReportTop1.Location = new Point(9, 143);
      this._appReportTop1.Multiline = true;
      this._appReportTop1.Name = "_appReportTop1";
      this._appReportTop1.ScrollBars = ScrollBars.Vertical;
      this._appReportTop1.Size = new Size(638, 79);
      this._appReportTop1.TabIndex = 19;
      this.label29.AutoSize = true;
      this.label29.ForeColor = SystemColors.ControlDark;
      this.label29.Location = new Point(390, 110);
      this.label29.Name = "label29";
      this.label29.Size = new Size(161, 13);
      this.label29.TabIndex = 18;
      this.label29.Text = "%%Date%% - дата регистрации";
      this.label28.AutoSize = true;
      this.label28.ForeColor = SystemColors.ControlDark;
      this.label28.Location = new Point(390, 98);
      this.label28.Name = "label28";
      this.label28.Size = new Size(181, 13);
      this.label28.TabIndex = 17;
      this.label28.Text = "%%CountSeeders%% - кол-во сидов";
      this.label27.AutoSize = true;
      this.label27.ForeColor = SystemColors.ControlDark;
      this.label27.Location = new Point(229, 98);
      this.label27.Name = "label27";
      this.label27.Size = new Size(151, 13);
      this.label27.TabIndex = 16;
      this.label27.Text = "%%Size%% - Размер раздачи";
      this.label26.AutoSize = true;
      this.label26.ForeColor = SystemColors.ControlDark;
      this.label26.Location = new Point(229, 111);
      this.label26.Name = "label26";
      this.label26.Size = new Size(155, 13);
      this.label26.TabIndex = 15;
      this.label26.Text = "%%Status%% - статус раздачи";
      this.label25.AutoSize = true;
      this.label25.ForeColor = SystemColors.ControlDark;
      this.label25.Location = new Point(6, 110);
      this.label25.Name = "label25";
      this.label25.Size = new Size(194, 13);
      this.label25.TabIndex = 14;
      this.label25.Text = "%%Name%% - наименование раздачи";
      this.label24.AutoSize = true;
      this.label24.ForeColor = SystemColors.ControlDark;
      this.label24.Location = new Point(6, 97);
      this.label24.Name = "label24";
      this.label24.Size = new Size(181, 13);
      this.label24.TabIndex = 13;
      this.label24.Text = "%%ID%% - идентификатор раздачи";
      this._appReportLine.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
      this._appReportLine.Location = new Point(9, 75);
      this._appReportLine.Name = "_appReportLine";
      this._appReportLine.Size = new Size(638, 20);
      this._appReportLine.TabIndex = 12;
      this.label17.AutoSize = true;
      this.label17.Location = new Point(6, 59);
      this.label17.Name = "label17";
      this.label17.Size = new Size(123, 13);
      this.label17.TabIndex = 11;
      this.label17.Text = "Шаблон строки отчета:";
      this.label9.AutoSize = true;
      this.label9.Location = new Point(6, 21);
      this.label9.Name = "label9";
      this.label9.Size = new Size(431, 13);
      this.label9.TabIndex = 9;
      this.label9.Text = "В отчете о сидируемых раздачах отображаются раздачи с кол-вом сидов не более:";
      this._appCountSeedersReport.Location = new Point(443, 19);
      this._appCountSeedersReport.Maximum = new Decimal(new int[4]
      {
        50,
        0,
        0,
      ...
      this._appCountSeedersReport.Minimum = new Decimal(new int[4]
      {
        1,
        0,
        0,
      ...
      this._appCountSeedersReport.Size = new Size(63, 20);
      this._appCountSeedersReport.TabIndex = 9;
      this._appCountSeedersReport.Value = new Decimal(new int[4]
      {
        10,
        0,
        0,
      ...
      this.label19.Location = new Point(6, 42);
      this.label19.Name = "label19";
      this.label19.Size = new Size(560, 13);
      this.label19.TabIndex = 10;
      this.label19.Text = "Если требуется что бы в отчет попадали все раздачи указанной категории, требуется указать значение \"-1\"";
      this.groupBox4.Controls.Add((Control) this._appIsNotSaveStatistics);
      this.groupBox4.Controls.Add((Control) this.label23);
      this.groupBox4.Controls.Add((Control) this._appLogLevel);
      this.groupBox4.Controls.Add((Control) this.label21);
      this.groupBox4.Controls.Add((Control) this.label20);
      this.groupBox4.Controls.Add((Control) this._appSelectLessOrEqual);
      this.groupBox4.Controls.Add((Control) this.label12);
      this.groupBox4.Controls.Add((Control) this._appIsUpdateStatistics);
      this.groupBox4.Controls.Add((Control) this._appPeriodRunAndStopTorrents);
      this.groupBox4.Controls.Add((Control) this.label11);
      this.groupBox4.Location = new Point(8, 161);
      this.groupBox4.Name = "groupBox4";
      this.groupBox4.Size = new Size(367, 415);
      this.groupBox4.TabIndex = 2;
      this.groupBox4.TabStop = false;
      this.groupBox4.Text = "Настройки программы";
      this._appIsNotSaveStatistics.AutoSize = true;
      this._appIsNotSaveStatistics.Location = new Point(6, 46);
      this._appIsNotSaveStatistics.Name = "_appIsNotSaveStatistics";
      this._appIsNotSaveStatistics.Size = new Size(296, 17);
      ...
      this._appIsNotSaveStatistics.Click += new EventHandler(this.SelectionChanged);
      this.label23.ForeColor = SystemColors.ControlDark;
      this.label23.Location = new Point(6, 198);
      this.label23.Name = "label23";
      this.label23.Size = new Size(355, 42);
      this.label23.TabIndex = 15;
      this.label23.Text = "Отвечает за подробность ведения текстового лога. 0 - ошибки/предупреждения, 1 - +информационные сообщения, 2 - + отладочные сообщения, 3 - + шаги выполнения программы";
      this._appLogLevel.Location = new Point(298, 175);
      this._appLogLevel.Maximum = new Decimal(new int[4]
      {
        5,
        0,
        0,
      ...
      this._appLogLevel.Size = new Size(63, 20);
      this._appLogLevel.TabIndex = 14;
      this.label21.AutoSize = true;
      this.label21.Location = new Point(6, 177);
      this.label21.Name = "label21";
      this.label21.Size = new Size(231, 13);
      this.label21.TabIndex = 13;
      this.label21.Text = "Уровень ведения логов (значение от 0 до 3)";
      this.label20.ForeColor = SystemColors.ControlDark;
      this.label20.Location = new Point(6, 142);
      this.label20.Name = "label20";
      this.label20.Size = new Size(355, 30);
      this.label20.TabIndex = 12;
      this.label20.Text = "Если флаг не установлен, то на главной форме будет использоваться строгое соответствие указаному значению";
      this._appSelectLessOrEqual.AutoSize = true;
      this._appSelectLessOrEqual.Location = new Point(6, 122);
      this._appSelectLessOrEqual.Name = "_appSelectLessOrEqual";
      this._appSelectLessOrEqual.Size = new Size(278, 17);
      ...
      this.label12.Location = new Point(6, 89);
      this.label12.Name = "label12";
      this.label12.Size = new Size(355, 30);
      this.label12.TabIndex = 7;
      this.label12.Text = "Операция по обновлению статистики ресурсоемкая при наличие большего кол-ва разделов и продолжается значительное время";
      this._appIsUpdateStatistics.AutoSize = true;
      this._appIsUpdateStatistics.Location = new Point(6, 69);
      this._appIsUpdateStatistics.Name = "_appIsUpdateStatistics";
      this._appIsUpdateStatistics.Size = new Size(301, 17);
      ...
      this._appPeriodRunAndStopTorrents.Location = new Point(259, 20);
      this._appPeriodRunAndStopTorrents.Maximum = new Decimal(new int[4]
      {
        1440,
        0,
        0,
      ...
      this._appPeriodRunAndStopTorrents.Minimum = new Decimal(new int[4]
      {
        10,
        0,
        0,
      ...
      this._appPeriodRunAndStopTorrents.Size = new Size(102, 20);
      this._appPeriodRunAndStopTorrents.TabIndex = 5;
      this._appPeriodRunAndStopTorrents.Value = new Decimal(new int[4]
      {
        30,
        0,
        0,
      ...
      this.label11.Size = new Size(247, 13);
      ...
      this.groupBox2.Controls.Add((Control) this._appCountDaysKeepHistory);
      this.groupBox2.Controls.Add((Control) this.label10);
      this.groupBox2.Controls.Add((Control) this._appIsAvgCountSeeders);
      this.groupBox2.Location = new Point(8, 84);
      this.groupBox2.Name = "groupBox2";
      this.groupBox2.Size = new Size(367, 71);
      this.groupBox2.TabIndex = 1;
      this.groupBox2.TabStop = false;
      this.groupBox2.Text = "Отбор раздач";
      this._appCountDaysKeepHistory.Location = new Point(218, 42);
      this._appCountDaysKeepHistory.Maximum = new Decimal(new int[4]
      {
        30,
        0,
        0,
      ...
      this._appCountDaysKeepHistory.Minimum = new Decimal(new int[4]
      {
        1,
        0,
        0,
      ...
      this._appCountDaysKeepHistory.Size = new Size(102, 20);
      this._appCountDaysKeepHistory.TabIndex = 6;
      this._appCountDaysKeepHistory.Value = new Decimal(new int[4]
      {
        7,
        0,
        0,
      ...
      this.label10.Location = new Point(6, 44);
      this.label10.Name = "label10";
      this.label10.Size = new Size(206, 13);
      this.label10.TabIndex = 1;
      this.label10.Text = "Хранить историю о кол-ве сидов, дней:";
      this._appIsAvgCountSeeders.AutoSize = true;
      this._appIsAvgCountSeeders.Location = new Point(6, 19);
      this._appIsAvgCountSeeders.Name = "_appIsAvgCountSeeders";
      this._appIsAvgCountSeeders.Size = new Size(302, 17);
      ...
      this.groupBox1.Controls.Add((Control) this._appKeeperPass);
      this.groupBox1.Controls.Add((Control) this._appKeeperName);
      this.groupBox1.Controls.Add((Control) this.label4);
      this.groupBox1.Location = new Point(8, 6);
      this.groupBox1.Name = "groupBox1";
      this.groupBox1.Size = new Size(367, 72);
      ...
      this.label8.Size = new Size(154, 13);
      this.label8.TabIndex = 3;
      this.label8.Text = "Пароль пользователя сайта:";
      this._appKeeperPass.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
      this._appKeeperPass.Location = new Point(166, 45);
      this._appKeeperPass.Name = "_appKeeperPass";
      this._appKeeperPass.PasswordChar = '*';
      this._appKeeperPass.Size = new Size(195, 20);
      this._appKeeperPass.TabIndex = 2;
      this._appKeeperName.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
      this._appKeeperName.Location = new Point(166, 19);
      this._appKeeperName.Name = "_appKeeperName";
      this._appKeeperName.Size = new Size(195, 20);
      ...
      this.tabPage1.Controls.Add((Control) this.forumPages1);
      this.tabPage1.Location = new Point(4, 22);
      this.tabPage1.Name = "tabPage1";
      this.tabPage1.Padding = new Padding(3);
      this.tabPage1.Size = new Size(1041, 591);
      this.tabPage1.TabIndex = 5;
      this.tabPage1.Text = "Отправка отчетов на форум";
      this.tabPage1.UseVisualStyleBackColor = true;
      this.forumPages1.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
      this.forumPages1.Location = new Point(0, 0);
      this.forumPages1.Name = "forumPages1";
      this.forumPages1.Size = new Size(1041, 591);
      this.forumPages1.TabIndex = 0;
      this._tpAllCategories.Controls.Add((Control) this.panel2);
      this._tpAllCategories.Location = new Point(4, 22);
      this._tpAllCategories.Name = "_tpAllCategories";
      this._tpAllCategories.Padding = new Padding(3);
      this._tpAllCategories.Size = new Size(1041, 591);
      ...
      this.panel2.Location = new Point(0, 54);
      this.panel2.Name = "panel2";
      this.panel2.Size = new Size(1041, 537);
      this.panel2.TabIndex = 0;
      this.panel2.Visible = false;
      this.AutoScaleDimensions = new SizeF(6f, 13f);
      this.AutoScaleMode = AutoScaleMode.Font;
      this.ClientSize = new Size(1050, 649);
      this.Controls.Add((Control) this._btCancel);
      this.Controls.Add((Control) this._btCheck);
      this.Controls.Add((Control) this._btSave);
      ...
      ((ISupportInitialize) this.dgwCategories).EndInit();
      this.tbpTorrentClients.ResumeLayout(false);
      this.groupBox5.ResumeLayout(false);
      this.groupBox5.PerformLayout();
      this.groupBox3.ResumeLayout(false);
      this.groupBox3.PerformLayout();
      ((ISupportInitialize) this.dgwTorrentClients).EndInit();
      this.tabControl1.ResumeLayout(false);
      this.tabPage2.ResumeLayout(false);
      this.groupBox8.ResumeLayout(false);
      this.groupBox8.PerformLayout();
      this._appCountSeedersReport.EndInit();
      this.groupBox4.ResumeLayout(false);
      this.groupBox4.PerformLayout();
      this._appLogLevel.EndInit();
      this._appPeriodRunAndStopTorrents.EndInit();
      this.groupBox2.ResumeLayout(false);
      this.groupBox2.PerformLayout();
      this._appCountDaysKeepHistory.EndInit();
